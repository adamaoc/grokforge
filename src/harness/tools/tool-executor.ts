...
import { findAccumulatedWriteForPath, mergeAgentEditProposals } from '../diff/edit-proposal-merge'
import type { AgentProfile } from '../profiles/agent-profile'
import { isToolAllowedForProfile } from '../profiles/agent-profile'
import type { GrokProjectManifest } from '../../main/manifest'
import type { ViteTemplateId } from './helpers/scaffold-command'
import { buildEditProposalValidationSummary, validateAgentEditProposal } from '../diff/edit-proposals'
import { executeRunCommandTool, parseRunCommandToolArgs } from './run-command-tool'
import {
  resolveSearchReplaceToWriteBatch,
  SearchReplaceToolArgsSchema,
} from '../diff/search-replace-tool'
import { recordSearchReplaceFailure, shouldBlockSearchReplaceAfterEscalation, ITERATIVE_SEARCH_REPLACE_BLOCKED_REASON } from '../policy/edit/cascade-guard'
import {
  isCreationRecoveryEnforced,
  qualifiesAsCreationRecoveryScaffold,
  recordCreationScaffoldAccepted,
} from '../policy/edit/creation-recovery'
...
import { runSubagentSession } from '../subagent/runner'
import { AgentToolBatchPayloadSchema } from './contracts/tool-schema'
import { SpawnSubagentArgsSchema } from '../subagent/contracts/subagent-contract'
import type { AgentTurn } from '../../main/agent-turn'
