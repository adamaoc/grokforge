...
import { providerRequestFromSnapshot } from '../compaction/turn-snapshot'
import type {
  AgentChatActiveContext,
  AgentChatEventPayload,
  AgentChatToolName,
} from '../../shared/agent-chat-contract'
import type { AgentSubagentEventPayload } from './contracts/subagent-contract'
import {
...
import { resolveSubagentTurnRouting } from './contracts/subagent-routing'
import { getAgentProfile } from '../profiles/agent-profile'
import { getHarnessProfile } from '../profiles/harness-profile'
...
import { buildAgentToolExecutionContext } from '../tools/execution-context-builder'
import { executeAgentToolCall } from '../tools/tool-executor'
import { buildTurnSnapshot } from '../compaction/turn-snapshot-builder'
import {
...
import { clearAgentTurnReads } from '../context/turn-read-registry'
