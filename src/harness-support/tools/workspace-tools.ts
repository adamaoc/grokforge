...
import { getOrRefreshWorkspaceIndex, refreshWorkspaceIndex } from '../context/index-store'
import { rankRetrievalCandidates } from '../context/retrieval'
...
import { getAgentProfile, isToolAllowedForProfile } from '../profiles/agent-profile'
import type { AgentProfileId } from '../profiles/agent-profile'
import { isPathUnderProjectAgentOffload } from '../compaction/offload-store'
import { isPathUnderProjectAgentPlans } from '../plan/store/plan-store'
import { isPathUnderProjectChatStaging, toolPathLabelForAgent } from '../../main/chat/attachment-staging'
import { AGENT_TOOL_MAX_CONTENT_CHARS_PER_FILE, AGENT_TOOL_MAX_OPS } from './contracts/tool-contract'
import { CODE_QUALITY_CONTRACT_SHORT } from '../policy/quality/code-quality-contract'
import { AGENT_CONTEXT_BUDGETS } from '../compaction/context-budget-contract'
import { needsSourceLayoutRepair } from '../context/file-content-normalize'
